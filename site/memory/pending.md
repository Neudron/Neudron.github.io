...
| Tests | **1440 checks, 15 suites, all green** — re-verified 2026-08-19 by running every suite. fixes5 (53) fixes6 (48) fixes7 (73) fixes8 (99) fixes9 (63) fixes10 (97) fixes11 (75) fixes12 (63) fixes13 (79) fixes14 (70) fixes15 (106) fixes16 (185) **fixes17 (295)** fixes18 (89) playthrough (45) |
| Location | everything in `Documents\neu\site`, tests in `site\tests` |
| Deployed | ⚠️ **STAGED, not yet deployed (2026-08-19).** W5/W6 fixes + real-browser UAT done and ledgered (`uat-w5.md`); the push to `main` and deploy are the last step. Live site still runs `1c31455` |
...
| **3.5** | **Manual playthrough never done** — desktop or phone. Every check so far is jsdom. The W5 UAT list (`memory/uat-w5.md`) is the script; the new castle puzzles and the rage/tp/shield need eyes too | 🟡 | — | 1 hr |
